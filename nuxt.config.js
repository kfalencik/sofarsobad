    ...
    */
    ...
    head: {
      ...
      meta: [
        ...
        { hid: 'twitterimage', name: 'twitter:image', content: 'https://sofarsobad.co.uk/logo.jpg'},
        { hid: 'ogtitle', property: 'og:title', content: 'So Far So Bad - Ink Inspired, minimalist apparel'},
        { hid: 'ogtype', property: 'og:type', content: 'Website'},
        { hid: 'ogurl', property: 'og:url', content: 'https://sofarsobad.co.uk'},
        ...
        { hid: 'ogimage', property: 'og:image', content: 'https://sofarsobad.co.uk/logo.jpg'},
      ...
      link: [
        ...
        { rel: 'canonical', href: 'https://sofarsobad.co.uk/'},
