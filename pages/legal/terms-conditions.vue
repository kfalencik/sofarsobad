    ...
    <div class="container">
      ...
      <div class="columns">
        <div class="column is-half-widescreen">
          ...
          <p>3.2  In posting User Content, including reviews or making contact with other users of the Site you shall comply with our Acceptable Use Policy https://sofarsobad.co.uk/legal/privacy-policy.</p>
          ...
          <p>3.6  If you wish to complain about User Content uploaded by other users please contact us at help@sofarsobad.co.uk.</p>
          ...
          <p>9.9  In order to resolve a complaint regarding the Services or to receive further information regarding use of the Services, please contact us by email at help@sofarsobad.co.uk or by post to: </p>
          <div><br /> </div>
...
export default {
  head () {
    return {
      title: 'So Far So Bad - Terms & Conditions',
    }
  },
}
</script>
